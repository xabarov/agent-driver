    ...
    output = AgentRunOutput(
        ...
        events=[
            new_runtime_event(
                ...
                context={"run_id": "run_phase8_baseline", "attempt_id": "att_1", "seq": 1},
            ),
            new_runtime_event(
                event_type=RuntimeEventType.RUN_COMPLETED,
                context={"run_id": "run_phase8_baseline", "attempt_id": "att_1", "seq": 2},
            ),
        ],
    )
...
def test_context_quality_baseline_keeps_micro_above_trim() -> None:
    ...
    assert baseline["trim_plus_microcompaction"]["fact_recall"] >= baseline["trim_only"][
        "fact_recall"
    ]
