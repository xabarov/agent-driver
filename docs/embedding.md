...
| `agent_driver.memory` | `build_memory_provider` (one-call opt-in), `MemoryProvider`, `StoreBackedMemoryProvider`, `FactExtractingMemoryProvider`, `InMemoryMemoryStore`, `SqliteMemoryStore` |
