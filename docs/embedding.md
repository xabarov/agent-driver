...
| `agent_driver.contracts` | `AgentRunInput` / `AgentRunOutput`, `HarnessProfile`, `ToolManifest`, enums, message/usage/event models, including `MemoryStep` / `MemoryStepKind` for host memory projections |
