...
| Subagent orchestration | fan-out/fan-in lifecycle, join policy semantics, merge provenance, bounded handoff, crash-idempotent retries | Unit/eval/live | `tests/subagents/test_*.py`, `tests/runtime/test_subagent_integration.py`, `tests/evals/test_subagent_*.py`, `tests/runtime/test_live_subagent_openrouter.py` | Required for Phase 9 changes; do not default-enable before replay/eval/live gates pass |
