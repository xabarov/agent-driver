...
class RuntimeEventType(StrEnum):
    ...
    COMMAND_REDIRECTED = "command_redirected"
    COMMAND_PROMOTED = "command_promoted"
    COMMAND_STOP_PREEMPTED = "command_stop_preempted"
    NEXT_HANDOFF_COMPLETED = "next_handoff_completed"
    PLAN_MODE_ENTERED = "plan_mode_entered"
    PLAN_ARTIFACT_UPDATED = "plan_artifact_updated"
    ...
    LIFECYCLE_HOOK_STARTED = "lifecycle_hook_started"
    LIFECYCLE_HOOK_COMPLETED = "lifecycle_hook_completed"
    LIFECYCLE_HOOK_BLOCKED = "lifecycle_hook_blocked"
    LIFECYCLE_HOOK_FAILED = "lifecycle_hook_failed"
    LIFECYCLE_HOOK_TIMED_OUT = "lifecycle_hook_timed_out"
