...
def forced_final_no_tools_retry_reason(
    ...
    if content and response.finish_reason in (
        ...
        # A canned/wrong-language refusal is NOT an answer (shared predicate; without
        # this the forced-final ladder never engages — its entry gate saw non-empty
        # content — and the refusal was finalized verbatim, live 2026-07-19).
