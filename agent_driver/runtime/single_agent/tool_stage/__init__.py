...
from agent_driver.runtime.single_agent.tool_stage.events import (  # noqa: F401
    _emit_tool_progress_events,
    _emit_tool_completed_if_needed,
    _emit_tool_policy_runtime_decisions,
    _emit_artifact_events_from_tool_result,
    _emit_tool_started_if_needed,
)
...
def _apply_tool_call_step_limit(host: ToolStageHost, context: RunContext) -> None:
    ...
    limits = [value for value in (step_limit, remaining_global) if value is not None]
