"""E2B-backed python backend placeholder."""
...
class E2BPythonBackend:
    """Optional E2B backend to be implemented in follow-up."""
    ...
    async def execute(
        ...
        *,
        ...
        raise NotImplementedError("install agent-driver[e2b] and enable e2b backend implementation")
