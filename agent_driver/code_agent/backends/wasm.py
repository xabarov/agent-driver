"""Wasm-backed python backend placeholder."""
...
class WasmPythonBackend:
    """Optional wasm backend to be implemented in follow-up."""
    ...
    async def execute(
        ...
        *,
        ...
        raise NotImplementedError("install agent-driver[wasm] and enable wasm backend implementation")
